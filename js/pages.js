  ...
  window.HDS_PAGES = {
    start: function (meta) {
      return (
        ...
        '<section class="section"><h2 class="display">How to add or edit this system</h2><p class="stub-note" style="margin-bottom:20px">You describe the change. Cursor updates the site. You do not edit files or run commands.</p><div class="steps"><div class="step"><p class="step__num">01</p><p class="step__title">Publish in Figma first</p><p class="step__body">The Component Library is the source of truth. Publish the token or component before asking for the site to change.</p></div><div class="step"><p class="step__num">02</p><p class="step__title">Open this project in Cursor</p><p class="step__body">Paste what changed and the Figma URL. Say whether it is a token, a new component, an update, or a deprecate.</p></div><div class="step"><p class="step__num">03</p><p class="step__title">Review the live page</p><p class="step__body">Check the specimens against Figma. Ask Cursor to share it with the team when it looks right.</p></div></div></section><hr class="rule" />' +
